        ...
        >
            ...
            >
                ...
                <div class="padding-y-xxxs">
                    ...
                    <p v-if="item.category" class="text-sm color-contrast-medium margin-top-xxs">Category: {{ item.category.title }}</p>
                </div>
            </router-link>
            ...
            <div class="flex items-center margin-left-auto">
                <!-- Replicate -->
                <button @click="handleReplicate(item)" class="item__action reset margin-right-sm" type="button" name="button">
                ...
                <!-- Archive -->
                <button @click="handleDestroy(item)" class="item__action reset margin-right-sm" type="button" name="button">
                    <svg class="icon" viewBox="0 0 24 24">
